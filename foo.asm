...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 40 08 00 00       	mov    $0x840,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 f8 0a 00 00       	mov    0xaf8,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 f8 0a 00 00       	mov    %eax,0xaf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 f8 0a 00 00 fc 	movl   $0xafc,0xaf8
 7f7:	0a 00 00 
 7fa:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 801:	0a 00 00 
    base.s.size = 0;
 804:	b8 fc 0a 00 00       	mov    $0xafc,%eax
 809:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 810:	00 00 00 
