...
{   int wtime,rtime;
  ...
  1b:	7f 05                	jg     22 <main+0x22>
    ...
    exit();
  1d:	e8 90 02 00 00       	call   2b2 <exit>
    {   waitx(&wtime,&rtime);
  22:	50                   	push   %eax
  23:	50                   	push   %eax
  ...
  2b:	50                   	push   %eax
  2c:	e8 31 03 00 00       	call   362 <waitx>
  31:	83 c4 10             	add    $0x10,%esp
  34:	eb e7                	jmp    1d <main+0x1d>
        printf(1,"child created \n");
  36:	52                   	push   %edx
  37:	52                   	push   %edx
  38:	68 78 07 00 00       	push   $0x778
  3d:	6a 01                	push   $0x1
  3f:	e8 dc 03 00 00       	call   420 <printf>
        sleep(20);
  44:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
  4b:	e8 f2 02 00 00       	call   342 <sleep>
  50:	83 c4 10             	add    $0x10,%esp
  53:	eb c8                	jmp    1d <main+0x1d>
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
