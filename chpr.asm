...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb e4 07 00 00       	mov    $0x7e4,%ebx
        while(*s != 0){
 ...
 611:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 98 0a 00 00       	mov    %eax,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 98 0a 00 00    	mov    0xa98,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 98 0a 00 00    	cmp    %eax,0xa98
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 98 0a 00 00    	mov    0xa98,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 98 0a 00 00    	mov    %edx,0xa98
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 767:	0a 00 00 
 76a:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 9c 0a 00 00       	mov    $0xa9c,%eax
