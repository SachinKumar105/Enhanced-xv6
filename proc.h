...
struct proc {
  ...
  int priority;                // Process priority(0-100); lower value, higher priority;
  int ctime;                   // Creation time(ticks)
  int etime;                   // End-time
  int rtime;                   // Total time
  int wtime;                   // Total waiting time
  int runtime;                 // Total running time
  int sleeptime;               // Total sleeping time
  int clockticks[5];           // Number of clock ticks
  int num_run;                 // Number of times process is executed
  int queue_num;               // Queue number
  int time_quantums;           // Time Quantums remaining
  int last_run_time;           // No of ticks waiting in a queue
};
